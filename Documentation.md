...
### 2.3 Overzicht verantwoordelijkheden
...
- **Praktische realiteit**: klein team (~4 personen), beperkte tijd, geen dedicated DevOps-afdeling
...
![Schema](Diagrams/level1.png)

Level 2 - containerdiagram:
![Schema](Diagrams/level2.png)

Level 3 - deployment diagram:
![Schema](Diagrams/level3.png)